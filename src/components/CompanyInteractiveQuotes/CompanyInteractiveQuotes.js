...
function CompanyInteractiveQuotes({
  ...
  const { currency, companyName, ticker } = companyProfileData
    ...
    CREATE_OPERATION_MUTATION,
    {
      variables: {
        createOperationInput: {
          description: `${username} creates an operation buying ${numberOfActions} stocks @ ${currentPrice}  ${currency} from ${companyName}`,
